...
namespace SchiffeVersenken.Common
{
    /// <summary>
    ...
    public class NavigationHelper : DependencyObject
    {
            ...
            if (this.GoBackCommand.CanExecute(null))
            {
                ...
                if (frame != null)
                {
                    if (frame.Content != null)
                    {
                        ...
                        if (pageType.FullName.Equals("SchiffeVersenken.Views.GamePage"))
                        {
                            e.Handled = true;
                            this.Frame.Navigate(typeof(MainPage));
                   
                        }
                        else if (pageType.FullName.Equals("SchiffeVersenken.Views.HighscorePage"))
                        {
                            e.Handled = true;
                            this.Frame.Navigate(typeof(MainPage));
                        }
                        else if (!e.Handled && Frame.CurrentSourcePageType.FullName == "SchiffeVersenken.Views.MainPage")
                        {
        ...
        private async void SaveUser()
        {
            ...
            await storageService.Write("User.txt", App.MainView.Users);
